//! Constants translated from velocyto/constants.py

/// Bitmask flags for alignment overlap classification
pub const MATCH_INSIDE: u8 = 1;
/// Bitmask flags for alignment overlap classification
pub const MATCH_OVER5END: u8 = 2;
/// Bitmask flags for alignment overlap classification
pub const MATCH_OVER3END: u8 = 4;

/// Minimum flanking bases required for exon-intron overlap to be considered spanning
pub const MIN_FLANK: i64 = 5;
/// Tolerance (bp) for small indels in alignment matching
pub const PATCH_INDELS: i64 = 3;
/// Inaccuracy tolerance (bp) for splice junction matching
pub const SPLIC_INACUR: i64 = 6;
...
pub const BINSIZE_BP: i64 = 100_000;
pub const LONGEST_INTRON_ALLOWED: i64 = 1_000_000;
pub const BAM_COMPRESSION: u32 = 7;

/// Bitmask flags for feature classification
pub const EXON: u8 = 1;
/// Bitmask flags for feature classification — from another transcript of same gene
pub const ALT_EXON: u8 = 2;
/// Bitmask flags for feature classification — from an unrelated gene
pub const OTHER_EXON: u8 = 4;
/// Bitmask flags for feature classification
pub const INTRON: u8 = 8;
/// Bitmask flags for feature classification
pub const ALT_INTRON: u8 = 16;
/// Bitmask flags for feature classification
pub const OTHER_INTRON: u8 = 32;
/// Bitmask flags for feature classification
pub const COMPETING_INTRON: u8 = ALT_INTRON | OTHER_INTRON;
/// Bitmask flags for feature classification
pub const COMPETING_EXON: u8 = ALT_EXON | OTHER_EXON;

/// Length of placeholder random UMI added when -U flag is set (complexity = 36 per unit length)
pub const PLACEHOLDER_UMI_LEN: usize = 12;

pub const CIGAR: [&str; 10] = [
    "BAM_CMATCH",
    "BAM_CINS",
    "BAM_CDEL",
    "BAM_CREF_SKIP",
...
/// Mapping from GEM well barcode names to quadruplets of DNA sequences used in 10X chromium demultiplexing
pub static GEM_CODES: phf::Map<&'static str, [&'static str; 4]> = phf::phf_map! {
